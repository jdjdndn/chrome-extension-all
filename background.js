...
const CDN_REDIRECT_DOMAINS = [
  ...
  'fonts.font.im', 'gstatic.font.im', 'fonts.loli.net',
];
...
const CDN_REDIRECT_RULES = [
  ...
  { id: 3010, regex: '^https://cdnjs\\.cloudflare\\.com/ajax/libs/(.*)', sub: 'https://cdn.bootcdn.net/ajax/libs/\\1' },
  ...
  { id: 3012, regex: '^https://ajax\\.googleapis\\.com/ajax/libs/(.*)', sub: 'https://cdn.bootcdn.net/ajax/libs/\\1' },

  // ===== 路径变换替换 (源路径与目标路径结构不同) =====
  // bootstrapcdn → bootcdn (路径需加/ajax/libs/)
  { id: 3020, regex: '^https://(?:stackpath|maxcdn)\\.bootstrapcdn\\.com/(.*)', sub: 'https://cdn.bootcdn.net/ajax/libs/\\1' },
  // use.fontawesome.com → bootcdn (/releases/vX.Y.Z/ → /font-awesome/X.Y.Z/)
  { id: 3021, regex: '^https://use\\.fontawesome\\.com/releases/v(\\d+\\.\\d+\\.\\d+)/css/all(?:\\.min)?\\.css', sub: 'https://cdn.bootcdn.net/ajax/libs/font-awesome/\\1/css/all.min.css' },
  { id: 3022, regex: '^https://use\\.fontawesome\\.com/releases/v(\\d+\\.\\d+\\.\\d+)/css/fontawesome(?:\\.min)?\\.css', sub: 'https://cdn.bootcdn.net/ajax/libs/font-awesome/\\1/css/fontawesome.min.css' },
  // code.jquery.com UI themes → bootcdn (ui→jqueryui)
  { id: 3023, regex: '^https://code\\.jquery\\.com/ui/(\\d+\\.\\d+\\.\\d+)/themes/(.*)', sub: 'https://cdn.bootcdn.net/ajax/libs/jqueryui/\\1/themes/\\2' },
  // code.jquery.com Mobile CSS → bootcdn
  { id: 3024, regex: '^https://code\\.jquery\\.com/mobile/(\\d+\\.\\d+\\.\\d+)/(.*)\\.css', sub: 'https://cdn.bootcdn.net/ajax/libs/jquery-mobile/\\1/\\2.css' },
];
