...
class YouTubeScript extends SiteScript {
  ...
  createDrawer() {
    ...
    columnsLabel.style.cssText = 'display: block; margin-bottom: 8px; font-size: 14px; color: #333; font-weight: 500;';
    ...
    document.addEventListener('click', (e) => {
      ...
      if (drawer.style.right === '0px' && !drawer.contains(e.target) && e.target !== icon && !icon.contains(e.target)) {
        this.closeDrawer();
      }
    });
