 ...
 * 检查元素是否在视口内
 */
export function isElementInViewport(element: Element, options: ViewportOptions = {}): boolean {
 ...
 * 查找视口内唯一匹配的元素
 */
export function findOneInViewport(selector: string, options: ViewportOptions = {}): Element | null {
 ...
 * 查找所有在视口内的元素
 */
export function findAllInViewport(selector: string, options: ViewportOptions = {}): Element[] {
